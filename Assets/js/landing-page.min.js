...
! function (a) {
	var b = {
		...
		createScrollAnimation: function () {
			var b = {};
		...
		scrollAnimationHandler: function (b) {
			var c, d = a(this.element),
				e = ["animated"];
